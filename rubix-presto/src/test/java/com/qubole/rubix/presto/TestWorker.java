...
public class TestWorker implements HttpHandler
{
  ...
  class SingleWorker extends TestWorker
  {
    public SingleWorker()
    {
      super("[" +
  ...
  class MultipleWorkers extends TestWorker
  {
    public MultipleWorkers()
    {
      super("[" +
          ...
          "\"recentFailures\":119.00282273097419,\"recentSuccesses\":0.0," +
          "\"lastRequestTime\":\"2016-01-14T13:26:29.701Z\",\"lastResponseTime\":\"2016-01-14T13:26:29.701Z\"," +
          "\"recentFailureRatio\":1.0000003756693692,\"age\":\"21.81h\"," +
  ...
  class NoFailedNode extends TestWorker
  {
    public NoFailedNode()
    {
      super("[]\n");
  ...
  class OneFailedNode extends TestWorker
  {
    public OneFailedNode()
    {
      super("[" +
          "{\"uri\":\"http://192.168.1.3:8082\",\"recentRequests\":119.00277802527565," +
          "\"recentFailures\":119.00282273097419,\"recentSuccesses\":0.0," +
