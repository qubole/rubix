...
public class TestCachingValidator
{
  ...
  {
    checkValidator(new CoordinatorBookKeeper(conf, new BookKeeperMetrics(conf, new MetricRegistry(), false)), true);
  }
  ...
  public void testValidateCachingBehavior_verifyOtherMetricsUnaffected() throws TException, FileNotFoundException
  {
    ...
    final BookKeeper bookKeeper = new CoordinatorBookKeeper(conf, new BookKeeperMetrics(conf, metrics, false));
