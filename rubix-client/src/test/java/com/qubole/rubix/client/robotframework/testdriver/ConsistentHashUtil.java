...
public class ConsistentHashUtil
{
  ...
  public static String getHashedNodeForKey(List<String> nodeList, String key)
  {
    int nodeIndex = getNodeIndex(nodeList, key);
    return nodeList.get(nodeIndex);
  }

  public static int getNodeIndex(List<String> nodeList, String key)
  {
    // log.info(String.format("# Nodelist size: %d    Key: %s #", nodeList.size(), key));
  ...
  private static Integer getNextRunningNodeIndex(List<String> nodeList, int startIndex)
  {
  ...
  private static Integer getPreviousRunningNodeIndex(List<String> nodeList, int startIndex)
  {
